        ...
        >
          <div className="flex-1 flex items-center justify-start">
            <Link href="/" className="flex items-center gap-3 group" aria-label={t('header.home_aria')}>
              <PrimeDexLogo className="w-8 h-8 md:w-10 md:h-10 transition-transform group-hover:scale-105" />
                  ...
                  {mounted && (
                    <>
                      ...
                      <span className="text-[8px] font-black uppercase tracking-[0.2em] text-foreground/40">
                        {caughtPokemon.length} / 1025 {t('header.caught_label')}
                      </span>
                    </>
                  )}
                </div>
          ...
          <div className="flex-1 flex items-center justify-end gap-1.5 md:gap-2">
            ...
            <m.button
              ...
              title={t('header.language_title', { language: languageLabel })}
            ...
            <m.button
              ...
              title={t('header.theme_title', { theme: themeLabel })}
